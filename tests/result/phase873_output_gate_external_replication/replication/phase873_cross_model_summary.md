# Phase 873 Output Gate External Replication (replication)
...
| deepseek7b | complete | 8 | `['animal', 'color']` | `{'n': 8, 'tp': 0, 'fp': 3, 'fn': 1, 'tn': 4, 'precision': 0.0, 'recall': 0.0, 'accuracy': 0.5, 'source_clean_count': 3, 'holdout_clean_count': 1}` |
