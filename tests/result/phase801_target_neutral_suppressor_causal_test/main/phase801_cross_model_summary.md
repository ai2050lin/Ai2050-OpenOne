# Phase 801 Target-Neutral Suppressor Causal Test (main)
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| qwen3 | `target_neutral` | 8 | 4 | -0.703 | 0.756 | 0.206 | 0.418 | 0.053 | 0.000 | `{"neutral_suppression_with_residual_target_gain": 7, "weak_or_mixed": 1}` |
| qwen3 | `raw` | 8 | 4 | 2.785 | 0.734 | 0.734 | 0.035 | 0.137 | 0.000 | `{"raw_suppressor_like": 7, "weak_or_mixed": 1}` |
| qwen3 | `target_only` | 8 | 4 | 3.715 | -0.020 | 0.800 | 0.000 | 0.000 | 0.000 | `{"target_only_threshold_shift": 4, "weak_or_mixed": 4}` |
| glm4 | `target_neutral` | 8 | 4 | 0.043 | 0.395 | 0.298 | 0.238 | 0.086 | 0.000 | `{"neutral_suppression_with_residual_target_gain": 5, "weak_or_mixed": 3}` |
| glm4 | `raw` | 8 | 4 | 0.834 | 0.400 | 0.496 | 0.098 | 0.097 | 0.000 | `{"raw_suppressor_like": 3, "weak_or_mixed": 5}` |
| glm4 | `target_only` | 8 | 4 | 0.793 | 0.002 | 0.434 | 0.028 | 0.000 | 0.000 | `{"target_only_threshold_shift": 5, "weak_or_mixed": 3}` |
| deepseek7b | `target_neutral` | 8 | 4 | 0.938 | -0.415 | 0.337 | 0.367 | 0.000 | 0.000 | `{"weak_or_mixed": 8}` |
| deepseek7b | `target_only` | 8 | 4 | 2.960 | -0.140 | 0.559 | 0.072 | 0.000 | 0.000 | `{"target_only_threshold_shift": 6, "weak_or_mixed": 2}` |
| deepseek7b | `raw` | 8 | 4 | 3.557 | -0.549 | 0.732 | 0.124 | 0.000 | 0.000 | `{"weak_or_mixed": 8}` |
