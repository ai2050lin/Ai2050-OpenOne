#!/usr/bin/env python3
"""Check that Phase409 desktop and mobile WebGL captures are nonblank."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase409_dynamic_response_protocol/screenshots"
...
def main() -> None:
    ...
    payload = {
        "phase_id": "Phase409-CanvasPixelCheck",
    ...
    (SCREENSHOTS / "phase409_canvas_pixel_check.json").write_text(
