...
sec = r'D:/AI2050/Ai2050-OpenOne/tests/gpt5_temp/_p2853_memo_section.md'
body = open(sec, encoding='utf-8').read()
with open(memo, 'a', encoding='utf-8') as f:
    f.write(body)
lines = open(memo, encoding='utf-8').read().splitlines()
hits = [i + 1 for i, l in enumerate(lines) if 'Phase 2853' in l]
rep = r'D:/AI2050/Ai2050-OpenOne/tests/glm5/result/_p2853_memo_append.txt'
