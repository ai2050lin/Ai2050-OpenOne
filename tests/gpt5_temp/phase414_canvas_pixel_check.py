#!/usr/bin/env python3
"""Check that Phase414 desktop and mobile WebGL captures are nonblank."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase414_observer_event_preflight/screenshots"
...
def main() -> None:
    ...
    payload = {
        "phase_id": "Phase414-CanvasPixelCheck",
    ...
    (SCREENSHOTS / "phase414_canvas_pixel_check.json").write_text(
