#!/usr/bin/env python3
"""Check that Phase408 desktop and mobile WebGL captures are nonblank."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase408_partition_interface/screenshots"
...
def main() -> None:
    ...
    payload = {
        "phase_id": "Phase408-CanvasPixelCheck",
    ...
    (SCREENSHOTS / "phase408_canvas_pixel_check.json").write_text(
