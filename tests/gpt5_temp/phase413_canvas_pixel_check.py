#!/usr/bin/env python3
"""Check that Phase413 desktop and mobile WebGL captures are nonblank."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase413_prediction_kernel_preflight/screenshots"
...
def main() -> None:
    ...
    payload = {
        "phase_id": "Phase413-CanvasPixelCheck",
    ...
    (SCREENSHOTS / "phase413_canvas_pixel_check.json").write_text(
