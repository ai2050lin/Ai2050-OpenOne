#!/usr/bin/env python3
"""Read-only pixel check for Phase332 WebGL canvas screenshots."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase332_interface_branch_atlas/interface_branch_atlas/screenshots"
