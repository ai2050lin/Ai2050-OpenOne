#!/usr/bin/env python3
"""Check that Phase410 desktop and mobile WebGL captures are nonblank."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase410_orthogonal_preflight/screenshots"
...
def main() -> None:
    ...
    payload = {
        "phase_id": "Phase410-CanvasPixelCheck",
    ...
    (SCREENSHOTS / "phase410_canvas_pixel_check.json").write_text(
