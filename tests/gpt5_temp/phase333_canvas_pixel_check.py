#!/usr/bin/env python3
"""Read-only pixel check for Phase333 WebGL canvas screenshots."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase333_dynamic_path_atlas/dynamic_path_atlas/screenshots"
