#!/usr/bin/env python3
"""Check that Phase412 desktop and mobile WebGL captures are nonblank."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase412_typed_quotient_preflight/screenshots"
...
def main() -> None:
    ...
    payload = {
        "phase_id": "Phase412-CanvasPixelCheck",
    ...
    (SCREENSHOTS / "phase412_canvas_pixel_check.json").write_text(
