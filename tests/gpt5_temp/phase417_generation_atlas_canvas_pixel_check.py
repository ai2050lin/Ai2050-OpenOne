#!/usr/bin/env python3
"""Check Phase417 generation canvases are nonblank and interactive."""
...
SCREENSHOTS = ROOT / "tests/gpt5/result/phase417_native_generation_physical_atlas/screenshots"
...
def main() -> None:
    ...
    interactions = []
    desktop = []
    for path in sorted(SCREENSHOTS.glob("phase417_*_canvas.png")):
    ...
    payload = {
        "phase_id": "Phase417-GenerationAtlasCanvasPixelCheck",
    ...
    output = SCREENSHOTS / "phase417_generation_atlas_canvas_pixel_check.json"
