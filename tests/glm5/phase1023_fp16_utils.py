#!/usr/bin/env python3
"""Shared FP16 loading helpers for Phase1023."""
...
def load_fp16(model_name: str):
    """Load one local model in FP16 without any weight quantization."""
    if model_name == "qwen3":
    ...
    print(
        f"[phase1023-fp16] loading {model_name} with {max_memory}",
        flush=True,
    )
