#!/usr/bin/env python3
"""Finalize Phase1097 behavior authorization before hidden-state access."""
...
def main() -> None:
    ...
    result = {
        "schema_version": "phase1097_behavior_authorization.v1",
        "phase": protocol.PHASE,
        "protocol_digest": prereg["protocol_digest"],
        "models": model_records,
        "passing_models": passing_models,
        "hidden_scan_authorized": authorized,
        "decision": "run_conditional_transition_scan" if authorized else "stop_before_hidden_scan_and_repair_behavior_base",
    }
