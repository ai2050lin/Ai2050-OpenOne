#!/usr/bin/env python3
"""Phase1436: Qwen3 behavior qualification for C072 fresh two-surface material."""
...
def main() -> None:
    if (OUT / "analysis/final.json").exists():
        raise RuntimeError("Phase1436 exists")
    ...
    if contract_final["authorization"] != "run_phase1436_c072_behavior" or not contract_audit["all_checks_passed"]:
        raise RuntimeError("Phase1435 did not authorize behavior")
    ...
    try:
        ...
        summary = {
            ...
            "breadth_checks": breadth, "behavior_qualified": behavior_qualified, "numeric_same_shape_max_abs_diff": numeric_repeat,
        ...
        authorization = "run_phase1437_c072_permutation_camera" if behavior_qualified else "close_c072_at_behavior_gate"
