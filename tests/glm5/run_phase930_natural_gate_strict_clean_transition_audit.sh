...
ROUND_NAME="${1:-natural_gate_strict_clean_transition_audit}"
COMMON_ARGS=(
  ...
  --margin-factors 2.0,2.05,2.1,2.15,2.2,2.25
...
for MODEL in qwen3 glm4 deepseek7b; do
  python tests/glm5/phase930_natural_gate_strict_clean_transition_audit.py \
    --model "${MODEL}" \
    "${COMMON_ARGS[@]}"
done
