#!/usr/bin/env python3
"""Freeze the Phase1086 behavior gate before hidden-state collection."""
...
def main() -> None:
    ...
    result = {
        "schema_version": "phase1086_behavior_authorization.v1",
        ...
        "reason": (
            "The preregistered static and two-model behavior gates pass. "
            "Hidden collection remains restricted to the middle-band signed "
            "field scan; numerical failures remain visible in P10."
        ),
    }
