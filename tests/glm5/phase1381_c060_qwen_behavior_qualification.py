#!/usr/bin/env python3
"""Phase1381: behavior qualification for the independent C060 material."""
...
def parent() -> dict:
    ...
    expected = "run_phase1381_c060_behavior_qualification"
    if final.get("authorization") != expected or not audit.get("all_checks_passed"):
        raise RuntimeError("Phase1380 did not authorize behavior")
...
def main() -> None:
    ...
    if (OUT / "analysis/final.json").exists():
        raise RuntimeError("Phase1381 already exists")
    ...
    try:
        ...
        checks = {
            ...
            "partition_selected": all(
                sum(r["partition"] == p for r in selected) == split_target
