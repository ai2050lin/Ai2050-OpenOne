#!/usr/bin/env python3
"""Independent audit for Phase1457 C077 behavior."""
...
def main() -> None:
    ...
    expected = "run_phase1458_c077_discovery_full_field_capture" if summary["behavior_qualified"] else "close_c077_at_behavior_gate"
    checks = {
        "rows": len(rows) == 3456,
