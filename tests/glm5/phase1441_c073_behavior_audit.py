#!/usr/bin/env python3
"""Independent audit for Phase1441 C073 behavior."""
...
def main() -> None:
    ...
    expected = "run_phase1442_c073_matched_camera" if summary["behavior_qualified"] else "close_c073_at_behavior_gate"
