#!/usr/bin/env python3
"""Independent audit for Phase1436 C072 behavior."""
...
def main() -> None:
    ...
    expected = "run_phase1437_c072_permutation_camera" if summary["behavior_qualified"] else "close_c072_at_behavior_gate"
    ...
    result = {"phase": 1436, "campaign": "C072", "checks": checks, "passed": sum(checks.values()), "total": len(checks), "all_checks_passed": all(checks.values())}
