#!/usr/bin/env python3
"""Run Phase1098 end to end with exactly one FP16 model resident at a time."""
...
def main() -> None:
    ...
    call("phase1098_signature_block_audit.py")
    call("phase1098_relative_relation_geometry_protocol.py")
    for model_name in protocol.MODELS:
        ...
        if args.force or not output.exists():
            call("phase1098_relative_relation_geometry_behavior.py", model_name)
    call("phase1098_relative_relation_geometry_behavior_finalize.py")
    ...
    for model_name in protocol.MODELS:
        ...
        if args.force or not output.exists():
            call("phase1098_relative_relation_geometry_scan.py", model_name)
    call("phase1098_failure_diagnostic.py")
    call("phase1098_relative_relation_geometry_finalize.py")
    call("phase1098_result_audit.py")
