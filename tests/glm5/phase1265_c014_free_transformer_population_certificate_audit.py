"""Independent audit for Phase1265 C014 WP02."""
...
MAIN_PATH = ROOT / "tests/glm5/phase1265_c014_free_transformer_population_certificate.py"
SPEC = importlib.util.spec_from_file_location("phase1265_main", MAIN_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load Phase1265 main module")
