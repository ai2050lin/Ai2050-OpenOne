#!/usr/bin/env python3
"""Run Phase1078 models sequentially, then finalize and audit."""
...
def main() -> None:
    ...
    commands.append(run_command([
        ...
        str(
            ...
            / "tests"
            / "glm5"
            / "phase1078_shared_shell_pattern_atlas_protocol.py"
        ),
    ]))
    ...
    for model_name in protocol.MODELS:
        ...
        result = run_command([
            ...
            str(
                ...
                / "tests"
                / "glm5"
                / "phase1078_shared_shell_pattern_atlas_scan.py"
            ),
            model_name,
        ])
    ...
    commands.append(run_command([
        ...
        str(
            ...
            / "tests"
            / "glm5"
            / "phase1078_shared_shell_pattern_atlas_finalize.py"
        ),
    ]))
    commands.append(run_command([
        python,
        str(
            ...
            / "tests"
            / "glm5"
            / "phase1078_result_audit.py"
        ),
    ]))
    manifest = {
        "schema_version": "phase1078_run_manifest.v1",
