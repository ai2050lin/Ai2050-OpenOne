"""Phase1265: free-Transformer external validity of the C014 certificate.
...
PHASE = 1265
CAMPAIGN = "C014"
CONTRACT_ID = "EXP-C014-WP02-001"
OUT = ROOT / "tests/glm5/result/phase1265_c014_free_transformer_population_certificate"
...
AUDITOR = ROOT / "tests/glm5/phase1265_c014_free_transformer_population_certificate_audit.py"
CONTRACT = ROOT / "research/ai2050_research_os/contracts/EXP-C014-WP02-001.json"
...
PROBE = ROOT / "tests/glm5_temp/phase1265_c014_free_transformer_population_certificate_probe.json"

ARCHITECTURES = same_executor.ARCHITECTURES
REPLICATES = 2
MODEL_SEEDS = {
    "shallow4_r0": 1_265_401_001,
    "shallow4_r1": 1_265_401_101,
    "middle6_r0": 1_265_601_001,
    "middle6_r1": 1_265_601_101,
    "deep8_r0": 1_265_801_001,
    "deep8_r1": 1_265_801_101,
}
MATERIAL_SEEDS = {
    "discovery": 1_265_910_001,
    "donor": 1_265_920_001,
    "causal_selection": 1_265_925_001,
    "confirmation": 1_265_930_001,
}
PARTITION_COUNTS = {
    "oracle": 3456,
    "discovery": 1024,
...
def protocol_payload(rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    timeless = {
        ...
        "schema_version": "phase1265.c014.free_transformer_population_certificate.v1",
...
def rff_parameters(device: torch.device) -> tuple[torch.Tensor, torch.Tensor]:
    generator = torch.Generator(device=device)
    generator.manual_seed(1_265_077)
    omega = torch.randn((2 * COMPRESSED_RANK, RFF_WIDTH), generator=generator, dtype=torch.float64, device=device) * 0.8
...
def feature_matrix(name: str, za: torch.Tensor, zb: torch.Tensor) -> torch.Tensor:
    ...
    if name == "quadratic":
        return quadratic
    if name == "rff":
        omega, phase = rff_parameters(x.device)
