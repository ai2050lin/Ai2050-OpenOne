#!/usr/bin/env python3
"""Run Phase1080 sequentially across the three local FP16 models."""
...
def main() -> None:
    ...
    commands.append(run_command([
        ...
        str(
            ...
            / "tests"
            / "glm5"
            / "phase1080_natural_relevance_atlas_protocol.py"
        ),
    ]))
    ...
    for model_name in protocol.MODELS:
        ...
        result = run_command([
            ...
            str(
                ...
                / "tests"
                / "glm5"
                / "phase1080_natural_relevance_atlas_scan.py"
            ),
            model_name,
        ])
    ...
    commands.append(run_command([
        ...
        str(
            ...
            / "tests"
            / "glm5"
            / "phase1080_natural_relevance_atlas_finalize.py"
        ),
    ]))
    commands.append(run_command([
        python,
    ...
    manifest = {
        "schema_version": "phase1080_run_manifest.v1",
