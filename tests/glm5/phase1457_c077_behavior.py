#!/usr/bin/env python3
"""Phase1457: behavior qualification for C077 labeled relations."""
...
PHASE, CAMPAIGN = 1457, "C077"
CONTRACT = TESTS / "result/phase1456_c077_labeled_relation_contract"
OUT = TESTS / "result/phase1457_c077_behavior"
BATCH = 24
...
def main() -> None:
    if (OUT / "analysis/final.json").exists():
        raise RuntimeError("Phase1457 exists")
    ...
    if contract_final["authorization"] != "run_phase1457_c077_behavior" or not contract_audit["all_checks_passed"]:
        raise RuntimeError("Phase1456 did not authorize behavior")
    ...
    try:
        ...
        summary = {
            ...
            "eligible_partition_counts": {name: sum(row["partition"] == name for row in eligible) for name in protocol["partitions"]},
            "checks": checks,
        ...
        authorization = "run_phase1458_c077_discovery_full_field_capture" if qualified else "close_c077_at_behavior_gate"
