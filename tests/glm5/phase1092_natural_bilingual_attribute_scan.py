#!/usr/bin/env python3
"""Collect Phase1092 natural bilingual signed fields, one model at a time."""
...
def run(model_name: str) -> None:
    ...
    result["schema_version"] = "phase1092_model_signed_summary.v1"
    result["behavior_status"] = (
        "authorized" if model_name in ("qwen3", "glm4") else "exploratory"
    )
