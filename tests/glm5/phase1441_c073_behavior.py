#!/usr/bin/env python3
"""Phase1441: Qwen3 behavior qualification for C073 order-reversed surfaces."""
...
PHASE, CAMPAIGN = 1441, "C073"
CONTRACT = TESTS / "result/phase1440_c073_side_phase_contract"
OUT = TESTS / "result/phase1441_c073_behavior"
BATCH = 24
...
def main() -> None:
    if (OUT / "analysis/final.json").exists():
        raise RuntimeError("Phase1441 exists")
    ...
    if contract_final["authorization"] != "run_phase1441_c073_behavior" or not contract_audit["all_checks_passed"]:
        raise RuntimeError("Phase1440 did not authorize behavior")
    ...
    try:
        ...
        authorization = "run_phase1442_c073_matched_camera" if behavior_qualified else "close_c073_at_behavior_gate"
