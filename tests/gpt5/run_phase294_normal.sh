...
export OUTPUT_DIR="${OUTPUT_DIR:-results/gpt5_phase294_dynamic_recompute_normal}"
...
RUN_ID="$(date +%Y%m%d_%H%M%S)_phase294normal_${MODEL}"
...
echo "=== Phase294 normal logged run ==="
date '+%Y-%m-%d %H:%M:%S %Z'
echo "run_id=${RUN_ID}"
echo "model=${MODEL}"
