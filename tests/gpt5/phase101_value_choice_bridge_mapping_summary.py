...
def main() -> None:
    ...
    paths = sorted(out_dir.glob("*_phase101_value_choice_bridge_mapping.json"))
    summary = {"phase": 101, "output_dir": str(out_dir), "models": [load_one(path) for path in paths]}
    ...
    out_path = out_dir / "phase101_value_choice_bridge_mapping_summary.json"
