...
for model in qwen3 glm4 deepseek7b; do
  python "${ROOT}/tests/gpt5/phase326_distributed_carrier_atlas.py" --model "${model}" --round "${ROUND}"
done
python "${ROOT}/tests/gpt5/phase326_distributed_carrier_atlas.py" --collect --round "${ROUND}"
