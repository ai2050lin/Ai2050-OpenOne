...
ROUND_NAME="${1:-protocol_gated_rollout_repair_audit}"
SCRIPT="tests/gpt5/phase200_protocol_gated_rollout_repair_audit.py"
...
run_model() {
  ...
  python "${SCRIPT}" \
    ...
    --phase198-round single_channel_sign_decomposition_atlas \
    ...
    --max-edges-per-model 5 \
    --max-samples-per-edge 16 \
