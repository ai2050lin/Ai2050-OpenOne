#!/usr/bin/env python3
"""Run the frozen Phase560 semantic source-color sufficiency screen."""
...
if __name__ == "__main__":
    ...
    run(
        args.batch_size,
        args.restart,
        contract_path=OUT_DIR / "phase560_semantic_color_screen_frozen_contract.json",
        ...
        rows_path=OUT_DIR / "phase560_semantic_color_screen_rows.jsonl",
        summary_path=OUT_DIR / "phase560_semantic_color_screen_execution_summary.json",
    )
