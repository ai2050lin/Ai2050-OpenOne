...
python tests/gpt5/phase354_semantic_time_case_bank.py
for model in qwen3 glm4 deepseek7b; do
  python tests/gpt5/phase354_semantic_time_contract_trace.py --model "$model"
done
python tests/gpt5/phase354_semantic_time_contract_analysis.py
