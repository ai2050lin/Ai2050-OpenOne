"""Test DeepSeek7B 4bit loading - uses less GPU memory"""
import sys
...
print("Starting 4bit load test...", flush=True)
...
print(f"GPU total: {torch.cuda.get_device_properties(0).total_memory/1e9:.1f} GB", flush=True)
