# Phase 781 Surface-Form Candidate Causal Patch and Ablation (confirm)
...
| qwen3 | `with_candidate_list:mlp:L34` | `with_candidate_list` | `mlp` | 34 | 5.527 |
| qwen3 | `with_candidate_list:mlp:L35` | `with_candidate_list` | `mlp` | 35 | 5.217 |
...
| glm4 | `lowercase_short_value:mlp:L39` | `lowercase_short_value` | `mlp` | 39 | 0.396 |
| glm4 | `with_candidate_list:attn:L35` | `with_candidate_list` | `attn` | 35 | 0.150 |
...
| deepseek7b | `with_candidate_list:mlp:L27` | `with_candidate_list` | `mlp` | 27 | 2.652 |
| deepseek7b | `with_candidate_list:attn:L25` | `with_candidate_list` | `attn` | 25 | 1.347 |
...
| qwen3 | `with_candidate_list:mlp:L34` | `normal_baseline` | 6 | 0.000 | 0.833 | 1.000 | -4.792 | null | null | null | null | null | `{"case_variant_target_value": 5, "whitespace_or_empty": 1}` |
| qwen3 | `with_candidate_list:mlp:L34` | `normal_donor` | 6 | 1.000 | 1.000 | 1.000 | 6.302 | null | null | null | null | null | `{"target_value": 6}` |
| qwen3 | `with_candidate_list:mlp:L34` | `patch_baseline_from_donor` | 6 | 0.167 | 1.000 | 1.000 | -2.792 | 2.000 | 0.167 | 0.000 | 0.000 | 0.000 | `{"case_variant_target_value": 5, "target_value": 1}` |
| qwen3 | `with_candidate_list:mlp:L34` | `replace_donor_with_baseline` | 6 | 0.833 | 0.833 | 0.833 | 4.729 | -1.573 | 0.000 | 0.167 | 0.167 | 0.167 | `{"contrast_value": 1, "target_value": 5}` |
| qwen3 | `with_candidate_list:mlp:L34` | `zero_donor_component` | 6 | 0.833 | 0.833 | 0.833 | 7.229 | 0.927 | 0.000 | 0.167 | 0.167 | 0.167 | `{"contrast_value": 1, "target_value": 5}` |
| qwen3 | `with_candidate_list:mlp:L35` | `normal_baseline` | 6 | 0.000 | 0.833 | 1.000 | -4.792 | null | null | null | null | null | `{"case_variant_target_value": 5, "whitespace_or_empty": 1}` |
| qwen3 | `with_candidate_list:mlp:L35` | `normal_donor` | 6 | 1.000 | 1.000 | 1.000 | 6.302 | null | null | null | null | null | `{"target_value": 6}` |
| qwen3 | `with_candidate_list:mlp:L35` | `patch_baseline_from_donor` | 6 | 0.167 | 0.833 | 0.833 | -2.667 | 2.125 | 0.167 | 0.000 | 0.167 | 0.167 | `{"case_variant_contrast_value": 1, "case_variant_target_value": 4, "target_value": 1}` |
| qwen3 | `with_candidate_list:mlp:L35` | `replace_donor_with_baseline` | 6 | 0.833 | 0.833 | 1.000 | 4.625 | -1.677 | 0.000 | 0.167 | 0.167 | 0.000 | `{"lexical_capitalized": 1, "target_value": 5}` |
| qwen3 | `with_candidate_list:mlp:L35` | `zero_donor_component` | 6 | 1.000 | 1.000 | 1.000 | 5.026 | -1.276 | 0.000 | 0.000 | 0.000 | 0.000 | `{"target_value": 6}` |
...
| glm4 | `lowercase_short_value:mlp:L39` | `normal_baseline` | 6 | 0.000 | 1.000 | 1.000 | -1.229 | null | null | null | null | null | `{"case_variant_target_value": 6}` |
| glm4 | `lowercase_short_value:mlp:L39` | `normal_donor` | 6 | 0.500 | 1.000 | 1.000 | -0.052 | null | null | null | null | null | `{"case_variant_target_value": 3, "target_value": 3}` |
| glm4 | `lowercase_short_value:mlp:L39` | `patch_baseline_from_donor` | 6 | 0.000 | 1.000 | 1.000 | -0.948 | 0.281 | 0.000 | 0.000 | 0.000 | 0.000 | `{"case_variant_target_value": 6}` |
| glm4 | `lowercase_short_value:mlp:L39` | `replace_donor_with_baseline` | 6 | 0.167 | 1.000 | 0.833 | -0.344 | -0.292 | 0.000 | 0.333 | 0.000 | 0.167 | `{"case_variant_target_value": 5, "target_value": 1}` |
| glm4 | `lowercase_short_value:mlp:L39` | `zero_donor_component` | 6 | 0.667 | 0.667 | 1.000 | 0.865 | 0.917 | 0.167 | 0.000 | 0.333 | 0.000 | `{"lexical_capitalized": 1, "lexical_word": 1, "target_value": 4}` |
...
| glm4 | `with_candidate_list:attn:L35` | `normal_baseline` | 6 | 0.000 | 1.000 | 1.000 | -1.229 | null | null | null | null | null | `{"case_variant_target_value": 6}` |
| glm4 | `with_candidate_list:attn:L35` | `normal_donor` | 6 | 1.000 | 1.000 | 1.000 | 1.771 | null | null | null | null | null | `{"target_value": 6}` |
| glm4 | `with_candidate_list:attn:L35` | `patch_baseline_from_donor` | 6 | 0.000 | 1.000 | 1.000 | -1.125 | 0.104 | 0.000 | 0.000 | 0.000 | 0.000 | `{"case_variant_target_value": 6}` |
| glm4 | `with_candidate_list:attn:L35` | `replace_donor_with_baseline` | 6 | 1.000 | 1.000 | 1.000 | 1.615 | -0.156 | 0.000 | 0.000 | 0.000 | 0.000 | `{"target_value": 6}` |
| glm4 | `with_candidate_list:attn:L35` | `zero_donor_component` | 6 | 1.000 | 1.000 | 1.000 | 1.646 | -0.125 | 0.000 | 0.000 | 0.000 | 0.000 | `{"target_value": 6}` |
...
| glm4 | `with_candidate_list:mlp:L38` | `replace_donor_with_baseline` | 6 | 0.667 | 1.000 | 1.000 | 0.625 | -1.146 | 0.000 | 0.333 | 0.000 | 0.000 | `{"case_variant_target_value": 1, "target_value": 5}` |
...
| deepseek7b | `lowercase_short_value:mlp:L26` | `normal_donor` | 6 | 0.500 | 0.667 | 0.667 | 0.216 | null | null | null | null | null | `{"case_variant_target_value": 1, "contrast_value": 1, "format_or_explanation_word": 1, "target_value": 3}` |
...
| deepseek7b | `lowercase_short_value:mlp:L27` | `normal_donor` | 6 | 0.500 | 0.667 | 0.667 | 0.216 | null | null | null | null | null | `{"case_variant_target_value": 1, "contrast_value": 1, "format_or_explanation_word": 1, "target_value": 3}` |
...
| deepseek7b | `lowercase_short_value:mlp:L27` | `zero_donor_component` | 6 | 0.667 | 0.667 | 0.667 | 0.397 | 0.181 | 0.167 | 0.000 | 0.000 | 0.000 | `{"contrast_value": 1, "format_or_explanation_word": 1, "target_value": 4}` |
| deepseek7b | `with_candidate_list:attn:L25` | `normal_baseline` | 6 | 0.000 | 0.833 | 0.667 | -5.167 | null | null | null | null | null | `{"case_variant_target_value": 5, "format_or_explanation_word": 1}` |
| deepseek7b | `with_candidate_list:attn:L25` | `normal_donor` | 6 | 0.167 | 1.000 | 0.667 | -1.948 | null | null | null | null | null | `{"case_variant_target_value": 5, "target_value": 1}` |
| deepseek7b | `with_candidate_list:attn:L25` | `patch_baseline_from_donor` | 6 | 0.000 | 0.833 | 0.667 | -4.779 | 0.388 | 0.000 | 0.000 | 0.000 | 0.000 | `{"case_variant_target_value": 5, "format_or_explanation_word": 1}` |
| deepseek7b | `with_candidate_list:attn:L25` | `replace_donor_with_baseline` | 6 | 0.167 | 0.833 | 0.500 | -1.760 | 0.188 | 0.000 | 0.000 | 0.167 | 0.167 | `{"case_variant_contrast_value": 1, "case_variant_target_value": 4, "target_value": 1}` |
| deepseek7b | `with_candidate_list:attn:L25` | `zero_donor_component` | 6 | 0.167 | 1.000 | 0.667 | -0.906 | 1.042 | 0.000 | 0.000 | 0.000 | 0.167 | `{"case_variant_target_value": 5, "target_value": 1}` |
...
| deepseek7b | `with_candidate_list:mlp:L27` | `normal_baseline` | 6 | 0.000 | 0.833 | 0.667 | -5.167 | null | null | null | null | null | `{"case_variant_target_value": 5, "format_or_explanation_word": 1}` |
| deepseek7b | `with_candidate_list:mlp:L27` | `normal_donor` | 6 | 0.167 | 1.000 | 0.667 | -1.948 | null | null | null | null | null | `{"case_variant_target_value": 5, "target_value": 1}` |
| deepseek7b | `with_candidate_list:mlp:L27` | `patch_baseline_from_donor` | 6 | 0.000 | 0.833 | 0.667 | -4.035 | 1.132 | 0.000 | 0.000 | 0.000 | 0.000 | `{"case_variant_target_value": 5, "format_or_explanation_word": 1}` |
| deepseek7b | `with_candidate_list:mlp:L27` | `replace_donor_with_baseline` | 6 | 0.000 | 0.833 | 0.667 | -2.938 | -0.990 | 0.000 | 0.167 | 0.167 | 0.000 | `{"case_variant_contrast_value": 1, "case_variant_target_value": 5}` |
| deepseek7b | `with_candidate_list:mlp:L27` | `zero_donor_component` | 6 | 0.167 | 0.667 | 0.833 | -0.260 | 1.688 | 0.000 | 0.000 | 0.333 | 0.000 | `{"case_variant_target_value": 3, "contrast_value": 1, "lexical_capitalized": 1, "target_value": 1}` |

## Top Sufficiency Candidates

| model | candidate | intervention | cases | delta margin | strict gain | score |
|---|---|---|---:|---:|---:|---:|
| qwen3 | `with_candidate_list:mlp:L35` | `patch_baseline_from_donor` | 6 | 2.125 | 0.167 | 0.354 |
| qwen3 | `with_candidate_list:mlp:L34` | `patch_baseline_from_donor` | 6 | 2.000 | 0.167 | 0.333 |
...
| glm4 | `lowercase_short_value:mlp:L39` | `patch_baseline_from_donor` | 6 | 0.281 | 0.000 | 0.000 |
| glm4 | `with_candidate_list:attn:L29` | `patch_baseline_from_donor` | 6 | 0.146 | 0.000 | 0.000 |
| glm4 | `with_candidate_list:attn:L35` | `patch_baseline_from_donor` | 6 | 0.104 | 0.000 | 0.000 |
...
| deepseek7b | `with_candidate_list:mlp:L27` | `patch_baseline_from_donor` | 6 | 1.132 | 0.000 | 0.000 |
...
| deepseek7b | `with_candidate_list:attn:L25` | `patch_baseline_from_donor` | 6 | 0.388 | 0.000 | 0.000 |

## Top Necessity Candidates

| model | candidate | intervention | cases | delta margin | strict loss | semantic loss | score |
|---|---|---|---:|---:|---:|---:|---:|
| qwen3 | `with_candidate_list:mlp:L35` | `replace_donor_with_baseline` | 6 | -1.677 | 0.167 | 0.167 | 0.419 |
| qwen3 | `with_candidate_list:mlp:L34` | `replace_donor_with_baseline` | 6 | -1.573 | 0.167 | 0.167 | 0.393 |
...
| glm4 | `lowercase_short_value:mlp:L39` | `replace_donor_with_baseline` | 6 | -0.292 | 0.333 | 0.000 | 0.097 |
| glm4 | `with_candidate_list:attn:L35` | `replace_donor_with_baseline` | 6 | -0.156 | 0.000 | 0.000 | 0.000 |
| glm4 | `with_candidate_list:attn:L35` | `zero_donor_component` | 6 | -0.125 | 0.000 | 0.000 | 0.000 |
...
| deepseek7b | `with_candidate_list:mlp:L27` | `replace_donor_with_baseline` | 6 | -0.990 | 0.167 | 0.167 | 0.247 |
